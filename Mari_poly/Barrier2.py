...
for i in range(3):
    image = initial.copy()
    image.set_calculator(JDFTx(executable='srun -n 1 -N 1 -c 12 --exclude=node[1001-1032]  /home/jfm343/JDFTXDIR/build/jdftx',pseudoDir='/home/jfm343/JDFTXDIR/build/pseudopotentials',pseudoSet='GBRV-pbe',commands={'elec-cutoff' : '20 100','kpoint': '.5 0 0','kpoint-folding' : '4 1 1', 'electronic-scf':' ', 'elec-smearing': 'Fermi 0.001','elec-n-bands': '23','spintype' :'z-spin'}))
    images.append(image)
